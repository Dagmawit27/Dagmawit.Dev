      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-8 flex justify-center gap-3 text-sm">
          <button
            ...
            className="rounded-full bg-foreground px-5 py-2.5 font-medium text-background transition hover:opacity-85"
          >
            Try again
          </button>
          <a
...
function LogoMark() {
  return (
    <span className="relative flex h-10 w-10 items-center justify-center rounded-2xl bg-foreground text-background">
      <span className="text-[15px] font-semibold tracking-tight">D</span>
      <span className="absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full bg-[var(--purple)]" />
    </span>
  );
}
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-foreground px-4 py-2 text-sm font-medium text-background transition hover:opacity-85"
        >
...
function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-border bg-muted/60">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-[1.4fr_1fr_1fr] md:px-10">
        <div>
